      ...
      <section id="about">
        ...
        >
          ...
          <p>
            ...
            aims to raise awareness and the understanding with how important it
            is to preserve native cultures and languages.
          </p>
        ...
        >
          ...
          <p>
            ...
            TypeScript, Next Webpack 5, Next App Routing, Zustand and Context
            API, and local storage, session storage, and local state. I also
            prepared and presented my findings to my team members, improving
            upon my documentation using the feedback and suggestions I received.
          </p>
        ...
        >
          ...
          <p>
            I have been attending NY Code And Coffee meetups for awhile, and it
            is the perfect environment to meet new people in the tech world.
            Having been founded by Steve Chen, I have made many new friends and
