...
export default function Nav(){
    ...
    <div id ="nav" className = {styles.nav}>
        <i id = "menu" className = {`${menu? `fa-solid fa-xmark ${styles.bars}` : `fa-solid fa-bars ${styles.bars}`}`} onClick = {(e)=>toggleMenu(menu)}></i>

        <nav className = {menu ? "menu" : "hidden"}>
            <ul>
                <li><h2>Menu</h2></li>
                <li><a className = {styles.link} href = "/">Home</a></li>
                <li><a className = {styles.link} href = "/aboutMe">About Me</a></li>
            ...
            <ul className = {`${styles.flex} ${styles["justify-between"]} ${styles.social} icons`}>
                ...
                <li><a className = {styles.link} target = "_blank" href="https://twitter.com/choir241"><small className="fa-brands fa-twitter"><span className = "hidden">Twitter</span></small></a></li>
            </ul>
        </nav>
        </div>
    )
