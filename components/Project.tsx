  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a target="_blank" href={props.codeURL} className={styles.button}>
            Code<small className="fa-solid fa-computer"></small>
          </a>
          <a target="_blank" href={props.demoURL} className={styles.button}>
            Demo<small className="fa-solid fa-arrow-right-from-bracket"></small>
          </a>
        </div>
      </section>
      ...
      <ul className={`${styles.flex} languages`}>{technologyList}</ul>
