    ...
    return(
        <header id = "header" className = {`${styles.flex} ${styles["justify-between"]} ${styles["align-center"]}`}>	
				...
				<ul className={styles.icons}>
					...
					<li id = "copyright"><small>Copyright &copy; {date.getFullYear()}. All rights are reserved</small></li>
				</ul>
				...
				<section className = {`${styles.callToAction} ${styles.flex} ${styles["flex-col"]} ${styles["justify-between"]}`}>
					...
					<a target = "_blank" href = "https://docs.google.com/document/d/1Gw7hqvLquVzKwg7fD3sfF1NGvoG0dFRzTI5rR-yEPkw/edit?usp=sharing" className = {styles.button}>View My Resume<small className = "fa-solid fa-file-lines"></small></a>
				</section>
