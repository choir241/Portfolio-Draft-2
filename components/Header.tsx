...
export default function Header() {
  return (
    <header className="pt-16 min-[2400px]:pt-40">
      <section className="flex justify-center max-[1000px]:flex-col items-center max-[1000px]:pt-10">
        <div className="flex flex-col justify-center w-4/6 mr-2 p-2 pl-8">
          ...
          <p className="text-4xl px-1 mt-6 mb-10 min-[2400px]:text-6xl min-[2400px]:leading-[6rem]">
            Located in NJ, I am a Technical Writer and Full Stack Developer. Content Creator and <a target="_blank" className="underline hover:opacity-70 hover:ease-in hover:duration-300" href="https://pieces.app/">Pieces for Developers</a> Certified Developer.
          </p>
