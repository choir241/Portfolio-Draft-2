  ...
  [931],
  {
        ...
        return (0, s.jsxs)("header", {
          ...
          children: [
            (0, s.jsxs)("ul", {
              ...
              children: [
                (0, s.jsx)("li", {
                  children: (0, s.jsx)("h1", { children: "Richard Choi" }),
                }),
                (0, s.jsx)("li", {
                  children: (0, s.jsx)("p", {
            ...
            (0, s.jsxs)("section", {
              ...
              children: [
                (0, s.jsxs)("a", {
                  ...
                  children: [
                    "View My GitHub",
                    (0, s.jsx)("small", { className: "fa-brands fa-github" }),
                  ],
                }),
                (0, s.jsxs)("a", {
                  target: "_blank",
                  ...
                  children: [
                    "View My LinkedIn",
                    (0, s.jsx)("small", { className: "fa-brands fa-linkedin" }),
                  ],
                }),
                (0, s.jsxs)("a", {
                  target: "_blank",
    ...
    1300: function (e, t, n) {
      ...
      let createStoreImpl = (e) => {
          ...
          return (t = e(setState, getState, s)), s;
        },
          ...
          let t = "function" == typeof e ? createStore(e) : e,
            useBoundStore = (e, n) =>
              (function (e, t = e.getState, n) {
                ...
                return (0, l.useDebugValue)(s), s;
              })(t, e, n);
          return Object.assign(useBoundStore, t), useBoundStore;
        },
        d = (s = (e) => ({ menu: !1, setMenu: (t) => e(() => ({ menu: t })) }))
          ? createImpl(s)
          : createImpl;
      var f = n(7438),
        h = n.n(f);
        ...
        return (0, i.jsxs)("div", {
          ...
          children: [
            (0, i.jsx)("i", {
              ...
              className: "".concat(
                e
                  ? "fa-solid fa-xmark ".concat(h().bars)
                  : "fa-solid fa-bars ".concat(h().bars),
              ),
              onClick: (n) => {
                e ? t(!1) : t(!0);
              },
            ...
            (0, i.jsxs)("nav", {
              ...
              children: [
                (0, i.jsxs)("ul", {
                  children: [
                    (0, i.jsx)("li", {
                      children: (0, i.jsx)("h2", { children: "Menu" }),
                    }),
                    (0, i.jsx)("li", {
                      children: (0, i.jsx)("a", {
                        className: h().link,
                ...
                (0, i.jsxs)("ul", {
                  className: ""
                    .concat(h().flex, " ")
                    .concat(h()["justify-between"], " ")
                    .concat(h().social, " icons"),
                  children: [
                    (0, i.jsx)("li", {
                      children: (0, i.jsx)("a", {
                        className: h().link,
    ...
    622: function (e, t, n) {
      ...
      function q(e, t, n) {
        ...
        t))
          l.call(t, s) && !o.hasOwnProperty(s) && (u[s] = t[s]);
        if (e && e.defaultProps)
    ...
    1853: function (e, t, n) {
      ...
      var d =
        ...
        void 0 === window.document.createElement
          ...
          : function (e, t) {
              var n = t(),
                s = l({ inst: { value: n, getSnapshot: t } }),
                i = s[0].inst,
                d = s[1];
              return (
                o(
                  function () {
                    (i.value = n), (i.getSnapshot = t), r(i) && d({ inst: i });
                  },
                  [e, n, t],
                ),
                c(
    ...
    8704: function (e, t, n) {
       ...
       */ var s = n(2265),
        ...
        d = s.useMemo,
        f = s.useDebugValue;
      t.useSyncExternalStoreWithSelector = function (e, t, n, s, i) {
        var h = o(null);
        if (null === h.current) {
          ...
          (h = d(
            function () {
              function a(t) {
                if (!o) {
                  if (
                    ((o = !0), (e = t), (t = s(t)), void 0 !== i && m.hasValue)
                  ) {
                    var n = m.value;
                    if (i(n, t)) return (c = n);
                  }
                ...
                var u = s(t);
                return void 0 !== i && i(n, u) ? n : ((e = t), (c = u));
              }
              var e,
                c,
                o = !1,
